...
def experiment(enableCtsRts):
    ...
    for flow_id, flow_stats in monitor.GetFlowStats ():
        ...
        if flow_id > 2:
            ...
            print("  Tx Packets: ", flow_stats.txPackets, file=sys.stdout)
            print("  Tx Bytes: ", flow_stats.txBytes, file=sys.stdout)
            print("  TxOffered:  ", flow_stats.txBytes * 8.0 / 9.0 / 1000 / 1000  , " Mbps", file=sys.stdout)
            print("  Rx Packets: ", flow_stats.rxPackets, file=sys.stdout)
            print("  Rx Bytes: ", flow_stats.rxBytes, file=sys.stdout)
            print("  Throughput: ", flow_stats.rxBytes * 8.0 / 9.0 / 1000 / 1000  , " Mbps", file=sys.stdout)
